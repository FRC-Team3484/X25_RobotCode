...
void SysIdForward::_ConfigureBindings() {
  ...
  // can have both sets of bindings at once
    (_driver_controller.A())
      .WhileTrue(_drivetrain.SysIdQuasistatic(frc2::sysid::Direction::kForward));
    (_driver_controller.B())
      .WhileTrue(_drivetrain.SysIdQuasistatic(frc2::sysid::Direction::kReverse));
    (_driver_controller.X())
      .WhileTrue(_drivetrain.SysIdDynamic(frc2::sysid::Direction::kForward));
    (_driver_controller.Y())
      .WhileTrue(_drivetrain.SysIdDynamic(frc2::sysid::Direction::kReverse));
}
