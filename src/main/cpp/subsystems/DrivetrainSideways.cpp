...
DrivetrainSideways::DrivetrainSideways()
{
...
frc2::CommandPtr DrivetrainSideways::SysIdQuasistatic(frc2::sysid::Direction direction) {
  	return _sysIdRoutine.Quasistatic(direction);
}

frc2::CommandPtr DrivetrainSideways::SysIdDynamic(frc2::sysid::Direction direction) {
  	return _sysIdRoutine.Dynamic(direction);
}

void DrivetrainSideways::SetBrakeMode() {
